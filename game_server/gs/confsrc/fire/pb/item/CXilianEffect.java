...
public class CXilianEffect implements mytools.ConvMain.Checkable ,Comparable<CXilianEffect>{

	public int compareTo(CXilianEffect o){
		return this.id-o.id;
	}
	...
	public CXilianEffect(CXilianEffect arg){
		this.id=arg.id ;
