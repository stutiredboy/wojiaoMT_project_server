...
public class Bag {
	...
	public static xbean.Bag get(Long key) {
		return _Tables_.getInstance().bag.get(key);
	}

	public static xbean.Bag get(Long key, xbean.Bag value) {
		return _Tables_.getInstance().bag.get(key, value);
	}

	public static void insert(Long key, xbean.Bag value) {
		_Tables_.getInstance().bag.insert(key, value);
	}

	public static void delete(Long key) {
		_Tables_.getInstance().bag.delete(key);
	}

	public static boolean add(Long key, xbean.Bag value) {
		return _Tables_.getInstance().bag.add(key, value);
	}

	public static boolean remove(Long key) {
		return _Tables_.getInstance().bag.remove(key);
	}

	public static mkdb.TTableCache<Long, xbean.Bag> getCache() {
		return _Tables_.getInstance().bag.getCache();
	}

	public static mkdb.TTable<Long, xbean.Bag> getTable() {
		return _Tables_.getInstance().bag;
	}
