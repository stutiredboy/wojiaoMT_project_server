...
public class Questbag {
	...
	public static xbean.Bag get(Long key) {
		return _Tables_.getInstance().questbag.get(key);
	}

	public static xbean.Bag get(Long key, xbean.Bag value) {
		return _Tables_.getInstance().questbag.get(key, value);
	}

	public static void insert(Long key, xbean.Bag value) {
		_Tables_.getInstance().questbag.insert(key, value);
	}

	public static void delete(Long key) {
		_Tables_.getInstance().questbag.delete(key);
	}

	public static boolean add(Long key, xbean.Bag value) {
		return _Tables_.getInstance().questbag.add(key, value);
	}

	public static boolean remove(Long key) {
		return _Tables_.getInstance().questbag.remove(key);
	}

	public static mkdb.TTableCache<Long, xbean.Bag> getCache() {
		return _Tables_.getInstance().questbag.getCache();
	}

	public static mkdb.TTable<Long, xbean.Bag> getTable() {
		return _Tables_.getInstance().questbag;
	}
