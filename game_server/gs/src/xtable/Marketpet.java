...
public class Marketpet {
	...
	public static xbean.Pets get(Long key) {
		return _Tables_.getInstance().marketpet.get(key);
	}

	public static xbean.Pets get(Long key, xbean.Pets value) {
		return _Tables_.getInstance().marketpet.get(key, value);
	}

	public static void insert(Long key, xbean.Pets value) {
		_Tables_.getInstance().marketpet.insert(key, value);
	}

	public static void delete(Long key) {
		_Tables_.getInstance().marketpet.delete(key);
	}

	public static boolean add(Long key, xbean.Pets value) {
		return _Tables_.getInstance().marketpet.add(key, value);
	}

	public static boolean remove(Long key) {
		return _Tables_.getInstance().marketpet.remove(key);
	}

	public static mkdb.TTableCache<Long, xbean.Pets> getCache() {
		return _Tables_.getInstance().marketpet.getCache();
	}

	public static mkdb.TTable<Long, xbean.Pets> getTable() {
		return _Tables_.getInstance().marketpet;
	}
