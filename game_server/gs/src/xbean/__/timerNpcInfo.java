...
public final class timerNpcInfo extends mkdb.XBean implements xbean.timerNpcInfo {
	...
	timerNpcInfo(int __, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
	}
	...
	public timerNpcInfo(timerNpcInfo _o_) {
		this(_o_, null, null);
	}

	timerNpcInfo(xbean.timerNpcInfo _o1_, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
		if (_o1_ instanceof timerNpcInfo) assign((timerNpcInfo)_o1_);
		else if (_o1_ instanceof timerNpcInfo.Data) assign((timerNpcInfo.Data)_o1_);
		else if (_o1_ instanceof timerNpcInfo.Const) assign(((timerNpcInfo.Const)_o1_).nThis());
		else throw new UnsupportedOperationException();
	}

	private void assign(timerNpcInfo _o_) {
	...
	private void assign(timerNpcInfo.Data _o_) {
		npcid = _o_.npcid;
		npcstatus = _o_.npcstatus;
		battletime = _o_.battletime;
		battleendtime = _o_.battleendtime;
	...
	@Override
	public xbean.timerNpcInfo copy() {
		_xdb_verify_unsafe_();
		return new timerNpcInfo(this);
	}

	@Override
	public xbean.timerNpcInfo toData() {
		_xdb_verify_unsafe_();
		return new Data(this);
	}

	public xbean.timerNpcInfo toBean() {
		_xdb_verify_unsafe_();
		return new timerNpcInfo(this); // same as copy()
	}

	@Override
	public xbean.timerNpcInfo toDataIf() {
		_xdb_verify_unsafe_();
		return new Data(this);
	}

	public xbean.timerNpcInfo toBeanIf() {
		_xdb_verify_unsafe_();
		return this;
	}
	...
	public final boolean equals(Object _o1_) {
		_xdb_verify_unsafe_();
		timerNpcInfo _o_ = null;
		if ( _o1_ instanceof timerNpcInfo ) _o_ = (timerNpcInfo)_o1_;
		else if ( _o1_ instanceof timerNpcInfo.Const ) _o_ = ((timerNpcInfo.Const)_o1_).nThis();
		else return false;
	...
	private class Const implements xbean.timerNpcInfo {
		timerNpcInfo nThis() {
			return timerNpcInfo.this;
		}
		...
		@Override
		public xbean.timerNpcInfo copy() {
			return timerNpcInfo.this.copy();
		}

		@Override
		public xbean.timerNpcInfo toData() {
			return timerNpcInfo.this.toData();
		}

		public xbean.timerNpcInfo toBean() {
			return timerNpcInfo.this.toBean();
		}

		@Override
		public xbean.timerNpcInfo toDataIf() {
			return timerNpcInfo.this.toDataIf();
		}

		public xbean.timerNpcInfo toBeanIf() {
			return timerNpcInfo.this.toBeanIf();
		}
		...
		public boolean isData() {
			return timerNpcInfo.this.isData();
		}

		@Override
		public OctetsStream marshal(OctetsStream _os_) {
			return timerNpcInfo.this.marshal(_os_);
		}
		...
		public mkdb.Bean xdbParent() {
			return timerNpcInfo.this.xdbParent();
		}

		@Override
		public boolean xdbManaged() {
			return timerNpcInfo.this.xdbManaged();
		}

		@Override
		public String xdbVarname() {
			return timerNpcInfo.this.xdbVarname();
		}

		@Override
		public Long xdbObjId() {
			return timerNpcInfo.this.xdbObjId();
		}

		@Override
		public boolean equals(Object obj) {
			return timerNpcInfo.this.equals(obj);
		}

		@Override
		public int hashCode() {
			return timerNpcInfo.this.hashCode();
		}

		@Override
		public String toString() {
			return timerNpcInfo.this.toString();
		}

	}

	public static final class Data implements xbean.timerNpcInfo {
		private int npcid; // //npcid 补充怪物时需要用到
		private int npcstatus; // //npckey 对应的战斗状态 0=空闲 1=战斗中 2=已经消失
		private int battletime; // //战斗中的人数
		private int battleendtime; // //战斗结束并胜利的人数
		...
		public xbean.timerNpcInfo toBean() {
			return new timerNpcInfo(this, null, null);
		}
		...
		@Override
		public final boolean equals(Object _o1_) {
			if (!(_o1_ instanceof timerNpcInfo.Data)) return false;
			timerNpcInfo.Data _o_ = (timerNpcInfo.Data) _o1_;
			if (npcid != _o_.npcid) return false;
			if (npcstatus != _o_.npcstatus) return false;
			if (battletime != _o_.battletime) return false;
			if (battleendtime != _o_.battleendtime) return false;
