...
public final class PvP1Role extends mkdb.XBean implements xbean.PvP1Role {
	...
	PvP1Role(int __, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
	}
	...
	public PvP1Role(PvP1Role _o_) {
		this(_o_, null, null);
	}

	PvP1Role(xbean.PvP1Role _o1_, mkdb.XBean _xp_, String _vn_) {
		super(_xp_, _vn_);
		if (_o1_ instanceof PvP1Role) assign((PvP1Role)_o1_);
		else if (_o1_ instanceof PvP1Role.Data) assign((PvP1Role.Data)_o1_);
		else if (_o1_ instanceof PvP1Role.Const) assign(((PvP1Role.Const)_o1_).nThis());
		else throw new UnsupportedOperationException();
	}

	private void assign(PvP1Role _o_) {
	...
	private void assign(PvP1Role.Data _o_) {
		grade = _o_.grade;
		score = _o_.score;
		battlenum = _o_.battlenum;
		winnum = _o_.winnum;
	...
	@Override
	public xbean.PvP1Role copy() {
		_xdb_verify_unsafe_();
		return new PvP1Role(this);
	}

	@Override
	public xbean.PvP1Role toData() {
		_xdb_verify_unsafe_();
		return new Data(this);
	}

	public xbean.PvP1Role toBean() {
		_xdb_verify_unsafe_();
		return new PvP1Role(this); // same as copy()
	}

	@Override
	public xbean.PvP1Role toDataIf() {
		_xdb_verify_unsafe_();
		return new Data(this);
	}

	public xbean.PvP1Role toBeanIf() {
		_xdb_verify_unsafe_();
		return this;
	}
	...
	public final boolean equals(Object _o1_) {
		_xdb_verify_unsafe_();
		PvP1Role _o_ = null;
		if ( _o1_ instanceof PvP1Role ) _o_ = (PvP1Role)_o1_;
		else if ( _o1_ instanceof PvP1Role.Const ) _o_ = ((PvP1Role.Const)_o1_).nThis();
		else return false;
	...
	private class Const implements xbean.PvP1Role {
		PvP1Role nThis() {
			return PvP1Role.this;
		}
		...
		@Override
		public xbean.PvP1Role copy() {
			return PvP1Role.this.copy();
		}

		@Override
		public xbean.PvP1Role toData() {
			return PvP1Role.this.toData();
		}

		public xbean.PvP1Role toBean() {
			return PvP1Role.this.toBean();
		}

		@Override
		public xbean.PvP1Role toDataIf() {
			return PvP1Role.this.toDataIf();
		}

		public xbean.PvP1Role toBeanIf() {
			return PvP1Role.this.toBeanIf();
		}
		...
		public boolean isData() {
			return PvP1Role.this.isData();
		}

		@Override
		public OctetsStream marshal(OctetsStream _os_) {
			return PvP1Role.this.marshal(_os_);
		}
		...
		public mkdb.Bean xdbParent() {
			return PvP1Role.this.xdbParent();
		}

		@Override
		public boolean xdbManaged() {
			return PvP1Role.this.xdbManaged();
		}

		@Override
		public String xdbVarname() {
			return PvP1Role.this.xdbVarname();
		}

		@Override
		public Long xdbObjId() {
			return PvP1Role.this.xdbObjId();
		}

		@Override
		public boolean equals(Object obj) {
			return PvP1Role.this.equals(obj);
		}

		@Override
		public int hashCode() {
			return PvP1Role.this.hashCode();
		}

		@Override
		public String toString() {
			return PvP1Role.this.toString();
		}

	}

	public static final class Data implements xbean.PvP1Role {
		private int grade; // 此记录所属的赛级
		private int score; // 积分
		private int battlenum; // 本场比赛的次数
		private int winnum; // 本场比赛赢的次数
		...
		public xbean.PvP1Role toBean() {
			return new PvP1Role(this, null, null);
		}
		...
		@Override
		public final boolean equals(Object _o1_) {
			if (!(_o1_ instanceof PvP1Role.Data)) return false;
			PvP1Role.Data _o_ = (PvP1Role.Data) _o1_;
			if (grade != _o_.grade) return false;
			if (score != _o_.score) return false;
			if (battlenum != _o_.battlenum) return false;
			if (winnum != _o_.winnum) return false;
