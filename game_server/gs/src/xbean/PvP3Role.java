...
public interface PvP3Role extends mkdb.Bean {
	public PvP3Role copy(); // deep clone
	public PvP3Role toData(); // a Data instance
	public PvP3Role toBean(); // a Bean instance
	public PvP3Role toDataIf(); // a Data instance If need. else return this
	public PvP3Role toBeanIf(); // a Bean instance If need. else return this
