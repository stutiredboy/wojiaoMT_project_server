...
public class CSetPetOpt extends __CSetPetOpt__ {
	...
	protected void process() {
		...
		if (petoptype > 0)
			new PReqSetHookDataProc(roleid, (short)HookDataUpdateEnum.HOOKDATA_PETOPTYPE, (long)petoptype).submit();
		if(petopid > 0)
			new PReqSetHookDataProc(roleid, (short)HookDataUpdateEnum.HOOKDATA_PETOPID, (long)petopid).submit();
