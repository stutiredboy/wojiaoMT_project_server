...
abstract class __CSendRedPackRoleRecordView__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class CSendRedPackRoleRecordView extends __CSendRedPackRoleRecordView__ {
	@Override
	protected void process() {
		...
		new PSendRedPackRoleRecordView(roleid, modeltype,redpackid).submit();
	}

	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 812540;
	...
	public CSendRedPackRoleRecordView(int _modeltype_, java.lang.String _redpackid_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CSendRedPackRoleRecordView) {
			CSendRedPackRoleRecordView _o_ = (CSendRedPackRoleRecordView)_o1_;
