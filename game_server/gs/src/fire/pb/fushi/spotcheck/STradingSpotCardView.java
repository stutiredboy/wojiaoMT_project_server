...
public class STradingSpotCardView extends __STradingSpotCardView__ {
	...
	public java.util.ArrayList<fire.pb.fushi.spotcheck.SpotCardInfo> sellspotcardinfolist; // 卖出
	public java.util.ArrayList<fire.pb.fushi.spotcheck.SpotCardInfo> buyspotcardinfolist; // 买入
