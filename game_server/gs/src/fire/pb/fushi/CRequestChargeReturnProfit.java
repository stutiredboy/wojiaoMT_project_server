...
/***
 * 闂傚倸鍊搁崐鎼佸磹閹间礁纾归柟闂寸绾惧湱锟界懓瀚崳纾嬨亹閹烘垹鍊為悷婊冪箻瀵娊鏁冮崒娑氬幈濡炪値鍘介崹鍨濠靛鐓曟繛鍡楃箳缁犲鏌＄仦绋垮⒉鐎垫澘瀚敓鏂ょ秵娴滄繈顢欓崨顓涙斀闁绘劕寮堕埢鏇灻瑰鍐煟鐎殿噮鍋婂畷鍫曨敆娴ｅ搫甯鹃梻濠庡亜濞诧箑煤閺嵮勬瘎闂傚倷绀侀幉锛勬崲閸愵喓锟藉啯绻濋崒銈嗙稁缂傚倷鐒﹂…鍥偡瑜版帗鐓曢柕澶嬪灥閸犳艾顭囬懡銈囩＝闁稿本鐟чˇ锔姐亜閿曞倷鎲剧�殿噮鍋嗛幏鐘绘嚑椤掍焦顔曢梻浣告惈濞层垽宕归崷顓犱笉闁挎繂妫涚弧锟介梺闈涢獜缁辨洜绮婚幘鍓佺＝鐎广儱鎷戝銉╂煟閿濆懎妲婚摶鏍煕濞戝崬骞樻い蟻鍥ㄢ拺闁稿繗鍋愰妶鎾煛閸涱喚绠為柛鈹垮灱缁犳盯寮撮悩纰夌闯闂備胶顭堥張顒勬偡瑜忕划浣冪疀濞戞瑧鍘垫俊鐐差儏妤犳悂宕㈤幘顔界厸閻忕偛澧介埥澶愭煟閿濆棛绠為柡浣规尰缁傛帞锟斤綆浜為敍娑㈡⒑缂佹ê濮夐柛搴涘�濆畷鎴﹀磼閻愬鍘搁梺鎼炲劗閺呮盯寮搁弮鍌滅＜闁绘宕甸悾娲煛瀹�锟介崰鎰焽韫囨稑绀堢憸蹇氭懌闂傚倷鑳剁划顖滄崲瀹ュ棛顩叉い蹇撶墕缁犳牗淇婇妶蹇斿濡炪値鍋呯换鍫ュ箖濞嗘搩鏁嗛柨鐔剁矙椤㈡棃鏁撻敓锟�?闂傚倸鍊搁崐鎼佸磹閹间礁纾归柟闂寸绾惧湱锟界懓瀚崳纾嬨亹閹烘垹鍊為梺闈浤涢崨顓㈢崕闂傚倷绀佹竟濠囧磻娓氾拷瀹曟洟鎳￠妶鍥╊槸闂佸搫璇炲畝锟介崬鐢告煟閻樼儤銆冮悹锟介敃鍌氱？闁硅揪闄勯悡鐔哥節闂堟稒顥犻柛鈺嬬秮閺岋紕浠﹂崜褎鍒涢梺绯曟櫅鐎氭澘鐣峰锟介、鏃堝川椤撶喓褰┑鐘垫暩閸嬬偤宕归崼鏇炵闁告縿鍎抽惌鎾舵喐閻楀牆绗掗柦鍐枛閺屻劌鈽夊Ο渚还濠电偛鐭堟禍顏堝箖瑜版帒鐐婇柕濞垮劤缁侀攱绻濆▓鍨灍婵炶尙鍠庨～蹇涙惞閸︻厾锛滃┑鈽嗗灥椤曆囨瀹ュ應鏀介柣鎰硾閻ㄦ椽鏌涢悩宕囧ⅹ妞ゆ洩绲剧换婵嗩潩椤戔斁鏅犻弻宥夊传閸曨偓鎷烽崨濠勵洸闁绘劗鍎ら埛鎴犵磼鐎ｎ偄顕滄繝锟介幍顔剧＜閻庯綆鍋勯悘瀛樸亜閵忊剝顥堥柡浣规崌閺佹捇鏁撻敓锟�?
 * @author changhao
 *
 */
