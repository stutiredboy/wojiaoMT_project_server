...
public class CReqChargeRefundsInfo extends __CReqChargeRefundsInfo__ {
	...
	protected void process() {
		...
		if(userinfo == null) {
			logger.error("CReqChargeRefundsInfo.AUUserInfo婵犵數濮烽弫鍛婃叏閻戣棄鏋侀柛娑橈攻閸欏繘鏌ｉ幋锝嗩棄闁哄绶氶弻鐔兼⒒鐎靛壊妲紒鐐劤椤兘寮婚敐澶婄疀妞ゆ帊鐒﹂崕鎾绘⒑閹肩偛濡奸柛濠傛健瀵鈽夐姀鈺傛櫇闂佹寧绻傚Λ娑⑺囬妷褏纾藉ù锝呮惈鏍″┑鐘灪椤牓鎮橀崘顔解拺闁圭娴风粻鎾绘煙閸愭煡鍙勭�殿喗濞婇幃娆撴倻濡厧骞堥梺纭呭閹活亞妲愰弴鐔告珡闂傚倷绀侀幖顐︽儗婢跺瞼绀婂ù锝呭閸ゆ洖霉閻樺樊鍎忛幆鐔兼⒑闂堟侗妾ч梻鍕閳绘捇銆傞敓锟�!userid:" + userid + ",roleid:" + roleid);
			return;
		}
