...
abstract class __SPvP1BattleInfo__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SPvP1BattleInfo extends __SPvP1BattleInfo__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 793540;
	...
	public SPvP1BattleInfo() {
		parameters = new java.util.LinkedList<com.locojoy.base.Octets>();
	}

	public SPvP1BattleInfo(byte _ismine_, int _msgid_, java.util.LinkedList<com.locojoy.base.Octets> _parameters_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SPvP1BattleInfo) {
			SPvP1BattleInfo _o_ = (SPvP1BattleInfo)_o1_;
