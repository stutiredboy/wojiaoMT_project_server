...
abstract class __CPvP1MyInfo__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class CPvP1MyInfo extends __CPvP1MyInfo__ {
	@Override
	protected void process() {
		...
		new mkdb.Procedure() {
			...
			protected boolean process() {
				...
				pvpRole.sendSPvP1MyInfo(race.isReady(roleId));
				return true;
			};
		}.submit();
	}
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 793533;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CPvP1MyInfo) {
			return true;
		}
		return false;
	}
	...
	public int compareTo(CPvP1MyInfo _o_) {
