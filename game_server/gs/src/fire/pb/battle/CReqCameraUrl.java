...
public class CReqCameraUrl extends __CReqCameraUrl__ {
	@Override
	protected void process() {
		...
		if (roleid < 0)
			return;
		new PSendCameraUrl(battleid, roleid).submit();
	}

	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 793733;
	...
	public CReqCameraUrl(long _battleid_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CReqCameraUrl) {
			CReqCameraUrl _o_ = (CReqCameraUrl)_o1_;
	...
	public int compareTo(CReqCameraUrl _o_) {
