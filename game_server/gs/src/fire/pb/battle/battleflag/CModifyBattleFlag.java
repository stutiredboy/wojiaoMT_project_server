...
abstract class __CModifyBattleFlag__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class CModifyBattleFlag extends __CModifyBattleFlag__ {
	@Override
	protected void process() {
		...
		if (roleid < 0)
			return;
		new PModifyBattleFlag(roleid,opttype,index,flag).submit();
	}

	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 793885;
	...
	public byte index; // 0-9 ÓÑ·½, 10-19µÐ·½
	...
	public CModifyBattleFlag(byte _opttype_, byte _index_, java.lang.String _flag_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CModifyBattleFlag) {
			CModifyBattleFlag _o_ = (CModifyBattleFlag)_o1_;
