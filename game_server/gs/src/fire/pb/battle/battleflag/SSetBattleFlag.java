...
abstract class __SSetBattleFlag__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SSetBattleFlag extends __SSetBattleFlag__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 793890;
	...
	public SSetBattleFlag() {
		flag = "";
	}

	public SSetBattleFlag(byte _opttype_, byte _index_, java.lang.String _flag_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SSetBattleFlag) {
			SSetBattleFlag _o_ = (SSetBattleFlag)_o1_;
