...
abstract class __SRuneRequestView__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SRuneRequestView extends __SRuneRequestView__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 808516;
	...
	public SRuneRequestView() {
		runerequestinfolist = new java.util.ArrayList<fire.pb.clan.RuneRequestInfo>();
	}

	public SRuneRequestView(int _requestnum_, java.util.ArrayList<fire.pb.clan.RuneRequestInfo> _runerequestinfolist_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SRuneRequestView) {
			SRuneRequestView _o_ = (SRuneRequestView)_o1_;
