...
abstract class __SOpenAutoJoinClan__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SOpenAutoJoinClan extends __SOpenAutoJoinClan__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 808499;
	...
	public SOpenAutoJoinClan(int _autostate_, short _requestlevel_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SOpenAutoJoinClan) {
			SOpenAutoJoinClan _o_ = (SOpenAutoJoinClan)_o1_;
	...
	public int compareTo(SOpenAutoJoinClan _o_) {
