	...
	protected void process() {
		...
		new mkdb.Procedure() {
			...
			protected boolean process() {
				...
				// 闂傚倸鍊搁崐鎼佸磹妞嬪海鐭嗗〒姘炬嫹鐎规洏鍎抽敓鏂ょ秵閸犳牜澹曢崸妤佺厵闁诡垳澧楅ˉ澶愬箹閺夋埊韬柡灞诲�楅崰濠囧础閻愬樊娼芥俊鐐�栭崝鎺斿垝濞嗗浚鍤曢柛顐ｆ礀闁卞洦绻涢幋鐏活亪鈥栫�ｎ喗鈷戠�规洖娲ㄧ敮娑欎繆椤愩垹鏆ｇ�殿喖顭峰鎾晬閸曨厽婢戦梻浣告惈濞层劑宕愰锕�唯鐟滃繐螞椤栨鏃堟晲閸涱厽娈堕梺浼欑稻濡炰粙寮婚垾宕囨殕閻庯綆鍓涜ⅵ濠电姷顣介崜婵嬪箖閸屾稐绻嗛柣鎴ｆ鍞銈嗘瀹曠數澹曢悙顒傜瘈闁汇垽娼ф禒婊堟煟鎺抽崝搴ㄥ礆閹烘绠婚柛鎾叉缁楀姊洪崫鍕檨闁告侗鍠楅鏇㈡⒒娴ｈ姤纭堕柛锝忕畵楠炲繘鏁撻敓锟�?
