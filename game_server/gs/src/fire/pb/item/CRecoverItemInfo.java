	...
	protected void process() {
		...
		new mkdb.Procedure() {
			...
			protected boolean process() {
				...
				// 闂傚倸鍊搁崐鎼佸磹閹间礁纾归柟闂寸绾剧懓顪冪�ｎ亝鎹ｉ柣顓炴閵嗘帒顫濋悙顒�顏堕柣搴ゎ潐濞插繘宕曢幎鑺ユ櫢闁哄倶鍊楃粔鐢告煕閻樺磭澧卞瑙勬礋瀹曠螖娴ｅ搫骞嶉梻浣筋嚃閸ㄨ櫕鏅跺Δ鍚藉寰勯幇顒傤啇闂佸搫顦伴崺濠囩叕椤掑嫭鐓涢悘鐐额嚙閿熻姤顨婂畷鐗堢節閸パ咁攨闂佺粯鍔曞Ο濠傤焽閼恒儰绻嗛柣鎰典簻閿熻姤鐗犲畷婵嬪箳閺傚灝鐏婂┑鐐叉濞存岸宕甸弴銏＄厱妞ゆ劧绲剧粈锟介梻浣稿船濞诧妇鎹㈠☉銏犵闁诲繑妞挎禍顏堝灳閺嶎偓鎷烽敐搴℃灍闁抽攱鍨归敓鍊燁潐濞叉牕煤閵娧勬殰婵炴垶鐟ょ换鍡樸亜閹扳晛鐏╅柡鍡悼閿熻姤顔栭崰鏍�﹀畡閭﹀殨闁圭虎鍠楅弲顒勬煕閺囥劌骞楁繝銏″灴濮婄粯鎷呴崨濠冨創濠电偛鐪伴崝鎴濈暦閹伴偊鏁冮柨鏇嫹閸烆垶鎮峰鍐閾荤偞銇勯弽顭戝殼闁哄啫鐗婇弲鏌ユ煕濞戝崬骞楁繛鍫濈埣濮婄儤瀵煎▎鎴犐戝┑锛勫仒缁瑥顕ｆ繝姘伋鐎规洖娲﹀▓鏇㈡煟鎼搭垳绉甸柛鎾寸閳灚绻濋悽闈浶ユい锝勭矙瀹曟粌鈹戠�ｎ亞鐣洪梺绋挎湰缁嬫劗鎹㈤崱娑欑厽闁硅揪绲鹃ˉ澶愬船椤栨凹娓婚柕鍫濇椤ュ棛锟借娲滈弫鍛婄珶閺囥垺鍊锋い鎺戝�婚惁鍫ユ⒑濮瑰洤鐏叉繛浣冲嫮顩锋繝濠傜墛閻撶喖骞掗幎钘夌閹兼番鍔岀粈鍡涙煙閻戞﹩娈旂紒鐘差煼閺屾盯骞橀崣澶樻▊缂備焦顨呴ˇ闈涱潖濞差亜浼犻柛鏇ㄥ枤濡俱劑姊洪崨濠佺繁闁哥姵顨婇、娆撳即閵忊檧鎷绘繛杈剧秬婵倗娑甸崼鏇熺厱闁挎繂绻掗悾鍨殽閻愯尙绠婚柡浣规崌閺佹捇鏁撻敓锟�?
