...
abstract class __SSearchFriend__ extends mkio.Protocol { }
...
public class SSearchFriend extends __SSearchFriend__ {
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 806571;
	...
	public SSearchFriend(fire.pb.friends.InfoBean _friendinfobean_) {
