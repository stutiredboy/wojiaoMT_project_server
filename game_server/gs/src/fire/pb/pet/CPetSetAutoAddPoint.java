...
abstract class __CPetSetAutoAddPoint__ extends mkio.Protocol { }
...
public class CPetSetAutoAddPoint extends __CPetSetAutoAddPoint__ {
	@Override
	protected void process() {
		...
		PPetSetAutoAddPointProc proc = new PPetSetAutoAddPointProc(roleid, petkey, str, iq, cons, endu, agi);
		proc.submit();
	}

	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 788512;
	...
	public CPetSetAutoAddPoint() {
	}

	public CPetSetAutoAddPoint(int _petkey_, int _str_, int _iq_, int _cons_, int _endu_, int _agi_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CPetSetAutoAddPoint) {
			CPetSetAutoAddPoint _o_ = (CPetSetAutoAddPoint)_o1_;
	...
	public int compareTo(CPetSetAutoAddPoint _o_) {
