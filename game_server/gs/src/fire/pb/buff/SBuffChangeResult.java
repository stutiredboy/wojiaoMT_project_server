...
public class SBuffChangeResult extends __SBuffChangeResult__ {
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 796442;
	...
	public SBuffChangeResult(int _agenttype_, long _id_, int _petid_, java.util.HashMap<Integer,fire.pb.buff.Buff> _addedbuffs_, java.util.LinkedList<Integer> _deletedbuffs_) {
	...
	public final boolean _validator_() {
		for (java.util.Map.Entry<Integer, fire.pb.buff.Buff> _e_ : addedbuffs.entrySet()) {
	...
	public OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		for (int size = _os_.uncompact_uint32(); size > 0; --size) {
			...
			fire.pb.buff.Buff _v_ = new fire.pb.buff.Buff();
			_v_.unmarshal(_os_);
