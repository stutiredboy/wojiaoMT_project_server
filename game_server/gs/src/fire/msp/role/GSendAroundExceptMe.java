...
abstract class __GSendAroundExceptMe__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class GSendAroundExceptMe extends __GSendAroundExceptMe__ {
	@Override
	protected void process() {
		Role role = RoleManager.getInstance().getRoleByID(roleid);
		if(role == null)
			return;
		role.sendOctetsAroundExceptMe(protype, protocol);
	}

	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 730902;
	...
	public GSendAroundExceptMe(long _roleid_, int _protype_, com.locojoy.base.Octets _protocol_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof GSendAroundExceptMe) {
			GSendAroundExceptMe _o_ = (GSendAroundExceptMe)_o1_;
