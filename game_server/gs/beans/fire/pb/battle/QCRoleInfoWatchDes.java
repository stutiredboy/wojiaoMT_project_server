...
public class QCRoleInfoWatchDes implements Marshal {
	...
	public QCRoleInfoWatchDes() {
		...
		role2 = new fire.pb.battle.QCRoleInfoDes();
	}

	public QCRoleInfoWatchDes(fire.pb.battle.QCRoleInfoDes _role1_, fire.pb.battle.QCRoleInfoDes _role2_) {
		this.role1 = _role1_;
		this.role2 = _role2_;
	}
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof QCRoleInfoWatchDes) {
