...
public class NewSubResultItem implements Marshal {
	...
	public java.util.LinkedList<fire.pb.battle.NewDemoResult> resultlist;

	public NewSubResultItem() {
		resultlist = new java.util.LinkedList<fire.pb.battle.NewDemoResult>();
	}

	public NewSubResultItem(int _subskillid_, int _subskillstarttime_, java.util.LinkedList<fire.pb.battle.NewDemoResult> _resultlist_) {
	...
	public final boolean _validator_() {
		for (fire.pb.battle.NewDemoResult _v_ : resultlist)
	...
	public OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; --_size_) {
			fire.pb.battle.NewDemoResult _v_ = new fire.pb.battle.NewDemoResult();
			_v_.unmarshal(_os_);
			resultlist.add(_v_);
		}
		return _os_;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof NewSubResultItem) {
