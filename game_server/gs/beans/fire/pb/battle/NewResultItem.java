...
public class NewResultItem implements Marshal {
	...
	public NewResultItem() {
		...
		subresultlist = new java.util.LinkedList<fire.pb.battle.NewSubResultItem>();
	...
	public NewResultItem(fire.pb.battle.DemoExecute _execute_, java.util.LinkedList<fire.pb.battle.NewSubResultItem> _subresultlist_, java.util.LinkedList<fire.pb.battle.FighterInfo> _newfighter_, java.util.HashMap<Integer,Float> _rolechangedattrs_, java.util.HashMap<Integer,Float> _petchangedattrs_) {
	...
	public final boolean _validator_() {
		...
		for (fire.pb.battle.NewSubResultItem _v_ : subresultlist)
	...
	public OctetsStream unmarshal(OctetsStream _os_) throws MarshalException {
		...
		for (int _size_ = _os_.uncompact_uint32(); _size_ > 0; --_size_) {
			fire.pb.battle.NewSubResultItem _v_ = new fire.pb.battle.NewSubResultItem();
			_v_.unmarshal(_os_);
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof NewResultItem) {
