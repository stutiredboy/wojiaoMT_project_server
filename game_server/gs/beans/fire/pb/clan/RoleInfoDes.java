...
public class RoleInfoDes implements Marshal {
	...
	public RoleInfoDes(int _moduletype_, long _roleid_, java.lang.String _rolename_, int _shape_, int _level_, int _camp_, int _school_, java.lang.String _clanname_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof RoleInfoDes) {
