...
public class Faction {
	...
	public static xbean.NameState get(String key) {
		return _Tables_.getInstance().faction.get(key);
	}

	public static xbean.NameState get(String key, xbean.NameState value) {
		return _Tables_.getInstance().faction.get(key, value);
	}

	public static void insert(String key, xbean.NameState value) {
		_Tables_.getInstance().faction.insert(key, value);
	}

	public static void delete(String key) {
		_Tables_.getInstance().faction.delete(key);
	}

	public static boolean add(String key, xbean.NameState value) {
		return _Tables_.getInstance().faction.add(key, value);
	}

	public static boolean remove(String key) {
		return _Tables_.getInstance().faction.remove(key);
	}

	public static xdb.TTableCache<String, xbean.NameState> getCache() {
		return _Tables_.getInstance().faction.getCache();
	}

	public static xdb.TTable<String, xbean.NameState> getTable() {
		return _Tables_.getInstance().faction;
	}
