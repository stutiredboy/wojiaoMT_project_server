 ...
 * @author dc@20150730
 */
public class NewMove extends Task_RoleBase {
	...
	public NewMove(LoginRole role) {
		super(role);
		init();
	}

	public NewMove(LoginRole role, boolean isNeedMap) {
		super(role);
		this.isNeedMap = isNeedMap;
		init();
	}
	...
	private void init() {
		...
		// 1616 1615 1614
		randomPos1616.add(new LogicPos(44 * 16, 210 * 16));
	...
	static private LogicPos getRandomPos(long mapid) {
		...
		} else if (mapid == 1609 || mapid == 1605 || mapid == 1606 || mapid == 1608 || mapid == 1611 || mapid == 1607
				|| mapid == 1610 || mapid == 1612) {
