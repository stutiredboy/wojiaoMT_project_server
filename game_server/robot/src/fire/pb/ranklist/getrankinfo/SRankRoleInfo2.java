...
public class SRankRoleInfo2 extends __SRankRoleInfo2__ {
	...
	public SRankRoleInfo2(long _roleid_, int _ranktype_, java.lang.String _rolename_, int _shape_, int _school_, int _level_, fire.pb.Bag _baginfo_, java.util.HashMap<Integer,com.locojoy.base.Octets> _tips_, int _footlogoid_, int _rank_, int _totalscore_, int _rolescore_, int _petscore_, int _manypetscore_, int _skillscore_, int _levelscore_, int _xiulianscore_, int _equipscore_, java.util.HashMap<Byte,Integer> _components_) {
