...
abstract class __SAddItem__ extends mkio.Protocol { }
...
public class SAddItem extends __SAddItem__ {
	...
	protected void process() {
		...
		if(role!= null){
			role.addItem(this.packid,data);
			role.getRoleBag().addItem(data);
			role.onRoleAddProtocol(this);
//			role.onDealProtocal(this);
		}
	}
	...
	public int packid;
	public java.util.ArrayList<fire.pb.Item> data;

	public SAddItem() {
		data = new java.util.ArrayList<fire.pb.Item>();
	}

	public SAddItem(int _packid_, java.util.ArrayList<fire.pb.Item> _data_) {
