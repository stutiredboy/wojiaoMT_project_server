...
abstract class __SVoteCandidate__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class SVoteCandidate extends __SVoteCandidate__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 810440;
	...
	public SVoteCandidate() {
		candidatelist = new java.util.ArrayList<fire.pb.school.CandidateInfo>();
	}

	public SVoteCandidate(int _alreadyvote_, java.util.ArrayList<fire.pb.school.CandidateInfo> _candidatelist_, long _shouxikey_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SVoteCandidate) {
			SVoteCandidate _o_ = (SVoteCandidate)_o1_;
