...
public class HuoBanDetailInfo implements Marshal {
	...
	public int state; // 是否解锁, 0为未解锁; 1为永久使用; 大于10为有多少分钟的剩余时间,如 134 表示为免费134 - 10 = 124分钟
	...
	public HuoBanDetailInfo(int _huobanid_, int _infight_, int _state_, int _weekfree_, java.util.ArrayList<Integer> _datas_) {
