...
public class SPetWash extends __SPetWash__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 788516;
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof SPetWash) {
			SPetWash _o_ = (SPetWash)_o1_;
	...
	public int compareTo(SPetWash _o_) {
