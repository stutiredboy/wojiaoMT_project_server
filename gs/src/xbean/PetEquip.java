...
public interface PetEquip extends mkdb.Bean {
	public PetEquip copy(); // deep clone
	public PetEquip toData(); // a Data instance
	public PetEquip toBean(); // a Bean instance
	public PetEquip toDataIf(); // a Data instance If need. else return this
	public PetEquip toBeanIf(); // a Bean instance If need. else return this
