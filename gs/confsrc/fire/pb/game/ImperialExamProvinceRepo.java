...
public class ImperialExamProvinceRepo implements mytools.ConvMain.Checkable {
	...
	public ImperialExamProvinceRepo(){
		super();
	}
	public ImperialExamProvinceRepo(ImperialExamProvinceRepo arg){
		this.id=arg.id ;
