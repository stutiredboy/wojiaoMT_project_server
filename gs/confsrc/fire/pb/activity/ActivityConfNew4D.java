...
public class ActivityConfNew4D implements mytools.ConvMain.Checkable ,Comparable<ActivityConfNew4D>{

	public int compareTo(ActivityConfNew4D o){
		return this.id-o.id;
	}
	...
	public ActivityConfNew4D(){
		super();
	}
	public ActivityConfNew4D(ActivityConfNew4D arg){
		this.id=arg.id ;
