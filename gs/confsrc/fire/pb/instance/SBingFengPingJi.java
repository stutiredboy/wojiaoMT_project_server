...
public class SBingFengPingJi implements mytools.ConvMain.Checkable ,Comparable<SBingFengPingJi>{

	public int compareTo(SBingFengPingJi o){
		return this.id-o.id;
	}
	...
	public SBingFengPingJi(){
		super();
	}
	public SBingFengPingJi(SBingFengPingJi arg){
		this.id=arg.id ;
