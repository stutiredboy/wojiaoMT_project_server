...
public class SLineTaskConfig implements mytools.ConvMain.Checkable ,Comparable<SLineTaskConfig>{

	public int compareTo(SLineTaskConfig o){
		return this.id-o.id;
	}
	...
	public SLineTaskConfig(){
		super();
	}
	public SLineTaskConfig(SLineTaskConfig arg){
		this.id=arg.id ;
