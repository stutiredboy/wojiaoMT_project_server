...
public class SPetEquipItemShuXing  extends ItemShuXing {

	public int compareTo(SPetEquipItemShuXing o){
		return this.id-o.id;
	}

	
	public SPetEquipItemShuXing(ItemShuXing arg){
		super(arg);
	}
	...
	public SPetEquipItemShuXing(){
		super();
	}
	public SPetEquipItemShuXing(SPetEquipItemShuXing arg){
		super(arg);
